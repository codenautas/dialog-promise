...
})(/*jshint -W040 */this, 'DialogPromise', function() {
/*jshint +W040 */
...
DialogPromise.alertPromise = alertPromise;
DialogPromise.confirmPromise = confirmPromise;
DialogPromise.promptPromise = promptPromise;
DialogPromise.dialogPromise = dialogPromise;
DialogPromise.miniMenuPromise = miniMenuPromise;
if (typeof window !== 'undefined') {
    window.alertPromise = alertPromise;
    window.confirmPromise = confirmPromise;
    window.promptPromise = promptPromise;
    window.dialogPromise = dialogPromise;
    window.miniMenuPromise = miniMenuPromise;
}
